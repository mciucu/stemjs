...
UI.TextElement = function () {
    function UITextElement(options) {
        babelHelpers.classCallCheck(this, UITextElement);
    ...
    babelHelpers.createClass(UITextElement, [{
        key: "mount",
...
var UIElement = function (_NodeWrapper) {
    babelHelpers.inherits(UIElement, _NodeWrapper);

    function UIElement(options) {
        babelHelpers.classCallCheck(this, UIElement);

        options = options || {};

        var _this = babelHelpers.possibleConstructorReturn(this, (UIElement.__proto__ || Object.getPrototypeOf(UIElement)).call(this, null, options, true));
    ...
    babelHelpers.createClass(UIElement, [{
        key: "setOptions",
        ...
        value: function cleanup() {
            ...
            this.clearNode();
            babelHelpers.get(UIElement.prototype.__proto__ || Object.getPrototypeOf(UIElement.prototype), "cleanup", this).call(this);
        }
    }, {
        key: "applyRef",
        ...
        value: function getDOMAttributes() {
            if (this.constructor.extraDOMAttributes) {
                var domAttributes = babelHelpers.get(UIElement.prototype.__proto__ || Object.getPrototypeOf(UIElement.prototype), "getDOMAttributes", this).call(this);
