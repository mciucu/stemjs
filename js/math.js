define(['exports'], function (exports) {
    ...
    var rand = exports.rand = function rand(mod) {
        return Math.floor(Math.random() * mod);
    };

    var equal = exports.equal = function equal(val1, val2) {
    ...
    var sqr = exports.sqr = function sqr(x) {
        return x * x;
    };
    ...
    var signedDistancePointLine = exports.signedDistancePointLine = function signedDistancePointLine(point, line) {
        return (line.a * point.x + line.b * point.y + line.c) / Math.sqrt(sqr(line.a) + sqr(line.b));
    };

    var distancePointLine = exports.distancePointLine = function distancePointLine(point, line) {
        return Math.abs(signedDistancePointLine(point, line));
    };

    var pointOnSegment = exports.pointOnSegment = function pointOnSegment(point, segmentStart, segmentEnd, epsilon) {
        epsilon = epsilon || EPS;
        return Math.abs(distance(point, segmentStart) + distance(point, segmentEnd) - distance(segmentStart, segmentEnd)) <= epsilon;
    };

    var perpendicularFoot = exports.perpendicularFoot = function perpendicularFoot(point, line) {
    ...
    var lineEquation = exports.lineEquation = function lineEquation(A, B) {
        return {
            a: B.y - A.y,
            b: A.x - B.x,
            c: A.y * B.x - A.x * B.y
    ...
    var angleGrad = exports.angleGrad = function angleGrad(p1, p2) {
        return gradian(angleRad(p1, p2));
    };

    // Transform gradian in radian
    var radian = exports.radian = function radian(angle) {
        return angle * Math.PI / 180;
    };

    // Transform radian in gradian
    var gradian = exports.gradian = function gradian(angle) {
        return angle * 180 / Math.PI;
    };

    // Compute angle between 2 points in rad
    var angleRad = exports.angleRad = function angleRad(p1, p2) {
        p2 = p2 || { 'x': 0, 'y': 0 };
        return Math.atan2(p1.y - p2.y, p1.x - p2.x);
    };

    // TODO: lots of these should be methods of the point class, not global functions
    var crossProduct = exports.crossProduct = function crossProduct(p1, p2, p0) {
        p0 = p0 || { x: 0, y: 0 };
        return (p1.x - p0.x) * (p2.y - p0.y) - (p1.y - p0.y) * (p2.x - p0.x);
    };

    var rotatePoint = exports.rotatePoint = function rotatePoint(point, orig, angle) {
    ...
    var translatePoint = exports.translatePoint = function translatePoint(point, dx, dy) {
        return {
            x: point.x + dx,
            y: point.y + dy
        };
    ...
    var scalePoint = exports.scalePoint = function scalePoint(point, orig, sx, sy) {
        sy = sy || sx;
        return {
    ...
    var polarToCartesian = exports.polarToCartesian = function polarToCartesian(angle, radius, orig) {
        orig = orig || { x: 0, y: 0 };
        return {
    ...
    var circlesIntersection = exports.circlesIntersection = function circlesIntersection(circle1, circle2) {
        var points;
        var centerDistance;
    ...
    var bound = exports.bound = function bound(value, minValue, maxValue) {
        if (value < minValue) {
            return minValue;
        }
        if (value > maxValue) {
    ...
    var getVector = exports.getVector = function getVector(startPoint, endPoint) {
        return {
    ...
    var vectorLength = exports.vectorLength = function vectorLength(vector) {
        return distance({ x: 0, y: 0 }, vector);
    };

    var normalizeVector = exports.normalizeVector = function normalizeVector(vector) {
    ...
    var scaleVector = exports.scaleVector = function scaleVector(vector, scalar) {
        return {
            x: vector.x * scalar,
            y: vector.y * scalar
        };
    ...
    var triangleArea = exports.triangleArea = function triangleArea(point1, point2, point3) {
        return 0.5 * Math.abs(crossProduct(point1, point2, point3));
    };

    var inRange = exports.inRange = function inRange(value, minValue, maxValue) {
        if (isNaN(value)) {
            return false;
        }
    ...
    var interpolationValue = exports.interpolationValue = function interpolationValue(interpolationArray, X) {
        var Y = 0;
        var aux;
        var i;
        var j;
